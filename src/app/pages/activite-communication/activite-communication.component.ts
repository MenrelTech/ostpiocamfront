...
@Component({
  selector: 'app-activite-communication',
  imports: [CardaddressComponent,ImgcardtextComponent],
  templateUrl: './activite-communication.component.html',
  styleUrl: './activite-communication.component.css'
})
export class ActiviteCommunicationComponent {
  hidden = true;
  hidden2 = true;
  hidden3 = true;
  hidden4 = true;
